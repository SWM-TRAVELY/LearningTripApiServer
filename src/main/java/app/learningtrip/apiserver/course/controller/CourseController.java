...
public class CourseController {
    ...
    public ResponseEntity<List<CourseThumbnail>> createGetCourse(@RequestBody CourseCreate courseCreate){

        return ResponseEntity.ok().body(courseService.createAutoGeneratedCourse(courseCreate));
    }
}
